...
| How do I prove what the bot proposed | [No audit view outside Enterprise](/blog/grok-bot-no-audit-log-yet) | It will not stand in as an action log |
...
Paste the amount with a date and a source: "copied from invoice, Friday 22 August 2026." From the phone app (iPhone or Android) you can approve steps, pause or resume a routine, read its run history, and delete it, but not edit or test it ([mobile](https://docs.x.ai/grok-bot/mobile)). Do not declare payback from a train seat.
...
On the phone you can open that history and pause. Write the score at a desk, on the sheet. There are Linux desktop and Android apps as of September 2026, and the iOS app also runs on iPad (iPadOS 18 or later) ([Grok Bot FAQ](https://docs.x.ai/grok-bot/faq)).
...
If you are not on an eligible plan, the objection does not apply. Every paid Cursor plan includes Grok Bot, from Cursor Pro at $20; Cursor Hobby, the free plan, does not, and an individual SuperGrok, SuperGrok Plus, SuperGrok Heavy or X Premium+ subscription can be linked instead. The cheapest individual paid door is Cursor Pro at 20 USD, checked 23 September 2026 on [cursor.com/pricing](https://cursor.com/pricing). Upgrade math lives on [Is Grok Bot worth it](/blog/is-grok-bot-worth-it). This page starts after the door is open, or on a timed trial job.
...
Pause from the phone if needed. At a desk, read the last twenty records, coarsen or delete the clock, then rewrite the charter. [Operating without a per-bot spend cap](/blog/grok-bot-no-spend-cap-ops) is the Friday roster ritual. This pause is one bot, two failed payback windows.
...
Bill shape (frequency, retries, long documents) is [Grok Bot cost](/blog/grok-bot-cost). Published plan prices and unpublished figures are [What AI bots actually cost](/blog/what-ai-bots-cost). Proof of what the bot proposed is [Grok Bot has no audit view outside Enterprise](/blog/grok-bot-no-audit-log-yet). Hours versus overflow will not tell a controller which vendor name was invented on 20 August.

[How to stop overspending](/blog/how-to-stop-grok-bot-overspending) is the hour you pause everything. [Operating without a per-bot spend cap](/blog/grok-bot-no-spend-cap-ops) is the Friday roster test. Use them when overflow is the emergency. Come back when the clocks are quiet and you want to know whether the surviving bot still returns hours.
...
**Keep reading:** [Grok Bot Cost: What You Pay and How Usage Adds Up](/blog/grok-bot-cost), [What AI Bots Actually Cost](/blog/what-ai-bots-cost), [Grok Bot Audit View: Keep Your Own Receipts Outside Enterprise](/blog/grok-bot-no-audit-log-yet).
