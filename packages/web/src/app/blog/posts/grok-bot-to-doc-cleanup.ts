...
// WHAT YOU PRODUCE
One flagged list, ranked by blast radius: a wrong runbook or a wrong
setup guide outranks a stale meeting note.
Each row: page title, link, last meaningful edit date, which pass fired,
the evidence, and a suggested disposition of KEEP, UPDATE, ARCHIVE, or
ASK OWNER.
...
## The false positive that wastes an afternoon
...
## Verifying it: argue with five flags before you trust any
