...
export const post: BlogPost = {
  title: 'Learn Grok Bot: A Curriculum From First Run to Your Own Boundary Line',
  description:
    'Learn Grok Bot through a 15-lesson curriculum covering inherited access, isolation, approvals, boundaries, plans, spend, skills, and routines.',
  date: '2026-08-29',
  category: 'Guide',
  content: `
...
| Curriculum section | Decision it helps you make |
|---|---|
| [Use this curriculum if you will operate, review, or buy a bot](#use-this-curriculum-if-you-will-operate-review-or-buy-a-bot) | Decide whether this learning path fits your role |
| [Run the lessons as tests, not as reading assignments](#run-the-lessons-as-tests-not-as-reading-assignments) | Turn each idea into observable practice |
| [Finish with five abilities you can demonstrate](#finish-with-five-abilities-you-can-demonstrate) | Define what completion means |
| [Correct one misconception at every stage](#correct-one-misconception-at-every-stage) | Catch the most expensive mental errors early |
| [What a Pasted Prompt Inherits the Moment It Runs](#what-a-pasted-prompt-inherits-the-moment-it-runs) | Inventory inherited state before executing text |
| [Screens Are Work Surfaces, Not Security Boundaries](#screens-are-work-surfaces-not-security-boundaries) | Separate organization from isolation |
| [Where a Bot Cookie Actually Lives and How Long It Stays](#where-a-bot-cookie-actually-lives-and-how-long-it-stays) | Trace browser identity across bots |
| [Why Deleting a Bot Leaves the Files and the Sessions](#why-deleting-a-bot-leaves-the-files-and-the-sessions) | Plan cleanup by object lifecycle |
| [What an Approval Actually Governs, and What It Cannot Undo](#what-an-approval-actually-governs-and-what-it-cannot-undo) | Place consent before the proposed action |
| [Approval Fatigue and the Blanket Yes That Undoes Your Boundary](#approval-fatigue-and-the-blanket-yes-that-undoes-your-boundary) | Preserve judgment in a repeated queue |
| [How to Write a Boundary Line a Bot Cannot Argue With](#how-to-write-a-boundary-line-a-bot-cannot-argue-with) | Name an observable stop and handoff |
| [A Boundary Is Not a Permission, and the Difference Bites](#a-boundary-is-not-a-permission-and-the-difference-bites) | Separate instruction from capability |
| [What Makes a Weak Boundary, With Six Real Examples](#what-makes-a-weak-boundary-with-six-real-examples) | Repair vague or exception-filled lines |
| [Who Can Actually Run Grok Bot, a Decision Tree](#who-can-actually-run-grok-bot-a-decision-tree) | Classify access from an exact plan label |
| [Why the Model Behind Grok Bot Is Not Published](#why-the-model-behind-grok-bot-is-not-published) | Avoid inventing a model identity |
| [What You Cannot Cap, and How to Budget Anyway](#what-you-cannot-cap-and-how-to-budget-anyway) | Operate without a bot-specific spend cap |
| [Which Surface Reads SKILL.md, and Why It Is Not This One](#which-surface-reads-skillmd-and-why-it-is-not-this-one) | Keep Grok Bot and Grok Build claims separate |
| [What a Routine Is, and Where It Dies With the Bot](#what-a-routine-is-and-where-it-dies-with-the-bot) | Preserve a recurring workflow before deletion |
| [The Five Questions to Answer Before Your First Bot](#the-five-questions-to-answer-before-your-first-bot) | Combine the curriculum into one charter |
| [Continue with one narrow bot and a review cadence](#continue-with-one-narrow-bot-and-a-review-cadence) | Move from lessons to controlled operation |
| [Frequently Asked Questions](#frequently-asked-questions) | Resolve the four questions beginners ask most |
...
Continue with [What a Pasted Prompt Inherits the Moment It Runs](/blog/what-a-pasted-prompt-inherits) for the full marker-file exercise and before-and-after state card.
...
Continue with [Screens Are Work Surfaces, Not Security Boundaries](/blog/screens-are-not-boundaries) to practice separating organizational convenience from security evidence.
...
Continue with [Where a Bot Cookie Actually Lives and How Long It Stays](/blog/where-a-bot-cookie-actually-lives) for the identity map and session cleanup exercise.
...
Continue with [Why Deleting a Bot Leaves the Files and the Sessions](/blog/why-deleting-a-bot-leaves-the-files) for the full lifecycle map and deletion checklist.
...
Continue with [What an Approval Actually Governs, and What It Cannot Undo](/blog/what-an-approval-actually-governs) for the action-timeline exercise and denial-state review.
...
Continue with [Approval Fatigue and the Blanket Yes That Undoes Your Boundary](/blog/approval-fatigue-and-the-blanket-yes) for queue design and blanket-approval failure tests.
...
The misconception is that stronger language needs to sound threatening or legal. It needs to be specific. Continue with [How to Write a Boundary Line a Bot Cannot Argue With](/blog/how-to-write-a-boundary-line) for four-part construction and edge-case tests.
...
Continue with [A Boundary Is Not a Permission, and the Difference Bites](/blog/a-boundary-is-not-a-permission) for the full instruction-capability matrix and mismatch exercises.
...
Continue with [What Makes a Weak Boundary, With Six Real Examples](/blog/what-makes-a-weak-boundary) for the six diagnostic patterns and worked rewrites.
...
Continue with [Who Can Actually Run Grok Bot, a Decision Tree](/blog/who-can-actually-run-grok-bot) for the complete eligibility worksheet and unresolved branch.
...
Continue with [Why the Model Behind Grok Bot Is Not Published](/blog/why-the-model-behind-grok-bot-is-unpublished) for the evidence hierarchy and claim-audit exercise.
...
Continue with [What You Cannot Cap, and How to Budget Anyway](/blog/what-you-cannot-cap) for the monitoring worksheet and overflow response plan.
...
Continue with [Which Surface Reads SKILL.md, and Why It Is Not This One](/blog/which-surface-reads-skill-md) for the surface matrix and metadata enforcement test.
...
Continue with [The Five Questions to Answer Before Your First Bot](/blog/the-five-questions-before-your-first-bot) to build the complete first-run charter and prediction worksheet.

## Continue with one narrow bot and a review cadence

After the last lesson, choose one job that produces a draft or review queue without external consequence. Do not begin with a fleet. A single narrow bot lets you see whether your environment inventory, evidence rules, boundary, approval placement, and usage review work together. Suitable catalog examples include [Bookmark Skill Grader](/bots/bookmark-skill-grader), which gives you a bounded review artifact, and [Personal CFO](/bots/personal-cfo), whose catalog boundary keeps financial movement human.
...
Keep reading: [build your first Grok Bot in an hour](/blog/first-grok-bot-in-an-hour), then use the [bot failure modes field guide](/blog/bot-failure-modes) to turn the first bad run into a regression test.
