...
It does not retell why sign-in runs through Cursor. That lives on
...
Three numbers still sit at the top of roundups, and none of them is the
cheapest grok bot plan. Grok Bot launched on 11 August 2026. Access widened
on 21 August 2026. Posts from that first window can be honest on publication
and still send you to the wrong cart.

Two hundred dollars was a reasonable individual floor when fewer plans
qualified. Cursor Ultra remains eligible. It is not the cheapest paid
...
The cheapest grok bot plan, if you do not already hold an eligible
subscription, is the one-time trial. It is limited usage. It is not a free
...
no publish. [Lead Scout](/bots/lead-scout) is the catalog version of that job.
Do not spend the meter connecting Gmail, a bank, or a CRM. Browser sessions
live on the account computer and survive bot deletion.
[Inbox Triage](/bots/inbox-triage) waits until you intend to keep the account.

How to spend the meter, click by click, is
[the free trial guide](/blog/grok-bot-free-trial). This page only cares that
...
Heavy is eligible. That is the only Heavy shopping fact that is safe to print.
Roundups that still open at two hundred dollars often invent a Heavy monthly
figure too. If [x.ai/pricing](https://x.ai/pricing) does not show a Heavy
price on the day you shop, you cannot compare it to Pro+ or Plus.

Do not wait for Heavy, and do not buy it because a post called it the real
...
Do not open the trial, and do not click upgrade, until the first job is
written down outside the product. The meter starts when the computer starts
working, not when you feel ready. Checkout is faster than drafting. Draft
first.

Mira pastes this and does not expand it:

\`\`\`text
Name: Monday Vendor Brief
Job: One question, public sources, one page

You answer one vendor or competitor question I name, using public pages
only. Every material claim has a URL. If a source will not open, write
blocked and stop. Do not keep browsing after the page is done.
...
That charter is the shopping instrument. If the trial cannot finish it, Pro+
will not magically finish it either. [Is Grok Bot worth it](/blog/is-grok-bot-worth-it)
is the verdict page after the packet exists. Do not buy a door for a job you
have not named. Do not schedule the Monday job during the trial. Routines
belong to one bot, max fifty per bot, twenty recent run records. Deleting the
...
This page will go stale the same way the two-hundred-dollar roundups went
stale. The fix is not a newer blog. The fix is your account screen and the
vendor pricing pages on the day you pay.

Before you click:

1. Read the eligible list on the [Grok Bot FAQ](https://docs.x.ai/grok-bot/faq).
2. Read [cursor.com/pricing](https://cursor.com/pricing) and
...
you still do not have a standing door. Wait after a clean trial, not instead
of one.

[Claude Cowork](/blog/grok-bot-vs-claude-cowork) and
[ChatGPT Work](/blog/grok-bot-vs-chatgpt-work) are different products. Confirm
those vendors' current pages if the repeating job already lives there. This
page will not print their prices as fact.

## Stop buying once the door opens and write the action the bot must never take

The shopping task ends when the entitlement shows in the app. Everything after
that is operations, and operations is where people who bought the cheap door
still get an expensive month.
...
"Do not use separate Bots as a security boundary" is the vendor line.
[The safety checklist](/blog/grok-bot-safety-checklist) is the first read after
checkout if you are about to connect mail. Usage shape after the door is open
is [Grok Bot cost](/blog/grok-bot-cost). The Build fork is
[Grok Bot versus Grok Build](/blog/grok-bot-vs-grok-build).

The stop line belongs in the first charter, not in a plan upgrade. For Mira,
the bot never sends, never pays, and never signs in. The cheap door stays
cheap when the irreversible verb stays human. That is not a SKU.

**Keep reading:** [Grok Bot free trial](/blog/grok-bot-free-trial), [Grok Bot cost](/blog/grok-bot-cost), [Is Grok Bot worth it](/blog/is-grok-bot-worth-it).
