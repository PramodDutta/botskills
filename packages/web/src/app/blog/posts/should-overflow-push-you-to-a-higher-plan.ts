...
export const post: BlogPost = {
  title: 'Should Overflow Push You to a Higher Grok Bot Plan',
  description:
    'Overflow should not auto-upgrade grok bot. Pause five-minute loops first. Decide should overflow push you to a higher plan only after the poller is paused.',
  date: '2026-08-28',
  category: 'Guide',
  content: `
# Should Overflow Push You to a Higher Grok Bot Plan

The upgrade cart that opens after overflow is usually a five-minute inbox bot
you have not paused, not a grok bot plan that ran out of capacity.

Overflow is an included weekly pool, then on-demand work billed from model
and token cost if the plan allows it
([Grok Bot FAQ](https://docs.x.ai/grok-bot/faq)). It is not a SKU ladder, not
a documented mid-week refill, and not a prompt to leave Pro+ for Ultra
because Tuesday's briefing was blank.

This page is the after-spike decision: stay and pause versus Pro+ versus Plus
versus Teams versus Ultra. It is not
[the cheapest door](/blog/cheapest-way-into-grok-bot),
[the Pro+ stamp](/blog/grok-bot-cursor-pro-plus),
[the Friday review](/blog/grok-bot-no-spend-cap-ops), or
...
will not invent a weekly allowance dollar. It will not print a SuperGrok
Heavy price. Heavy is eligible. Its number is not on the vendor page.

## Treat overflow as a SKU question only after every five-minute clock is paused

The question should overflow push you to a higher plan has a prerequisite
the billing UI will not ask. Pause first.

A five-minute inbox job is 12 fires an hour. If nights stay on, that is 288
fires in a day. Those counts are arithmetic from the clock, not a measured
pool size and not a price. The included weekly allowance has no published
dollar, credit, or run figure. You cannot prove those 288 fires would have
fit a larger SKU. You can prove the clock is still armed.

Pause every standing routine, including the quiet ones. All bots share one
persistent cloud computer assigned to the user, not to a bot
([computer and apps](https://docs.x.ai/grok-bot/computer-and-apps)). The
weekly pool follows that grain.
[Inbox Triage](/bots/inbox-triage) on five minutes can empty the week for
[Chief of Staff Briefing](/bots/chief-of-staff-briefing) and
[Standup Scribe](/bots/standup-scribe) without those two looking busy.
...
to reconstruct the burn while you shop a SKU.

## Park this decision off the door-in page, the Pro+ stamp page, Friday, and this-hour stop

Send the wrong hour to the wrong page and you will buy Ultra while a
five-minute clock is still scheduled.
...
## Confirm the invoice already names an eligible grok bot door

Overflow on Grok Bot only happens if Grok Bot already ran. If it already
ran, you already held an eligible path, or you spent trial credit. A higher
...
spelling. [The trial page](/blog/grok-bot-free-trial) is the meter.

## Refuse any quoted allowance dollar while you rank a higher plan

Roundups will quote a pool size. A coworker will quote credits. None of
those is a published allowance figure for a purchase order.

Eligible subscriptions include a weekly usage allowance. Overflow is
on-demand, billed from model and token cost. No published page prints that
allowance as dollars, credits, or runs. This article will not invent one.
If a page quotes a figure, treat the rest of that page as untrusted too,
especially if it also quotes SuperGrok Heavy.
...
Five answers. Only one of them is "buy a higher plan." Four of the five
are "you already had a door" or "you are buying people, not capacity."
...
Heavy stays off the priced rows. Confirm it on the live xAI page.

With both a Cursor subscription and a SuperGrok subscription, Grok Bot uses
whichever has more usage ([FAQ](https://docs.x.ai/grok-bot/faq)). That is
not documented as a Tuesday refill.
[Both subscriptions](/blog/grok-bot-both-subscriptions) is that model.

## Stay on the current SKU when the poller was the only new spend

If Monday you only changed the inbox clock, Tuesday is not a plan problem.

Stay means: pause every routine, delete or disable the five-minute owner
at a desk, leave briefing and standup paused, do today's packs yourself or
skip them, and keep the invoice you already have. Stay does not mean leave
the poller running and hope next week's unpublished pool is larger.

A routine assigns a workflow to one Bot. Max 50 routines per Bot. The app
keeps the 20 most recent run records per routine. Deleting a Bot deletes
its routines
([skills, routines and automations](https://docs.x.ai/grok-bot/skills-routines-and-automations)).
A five-minute inbox card at 1 of 50 is still the fire. Rank clocks, not
sidebar clutter.

[Mail Cleanup Assistant](/bots/mail-cleanup-assistant) on a leftover Sunday
is unused spend. Pause it. Retry is not stay. If overflow is on, try-again
is on-demand work. Confirm overflow in the product once. The bot reports
the pool is empty and waits. Do not create inbox-2 on five minutes from
...
Ultra on Tuesday because overflow sounded like Cursor capacity. Do not
step from Plus to Heavy because a roundup printed a Heavy price this page
will not repeat.

Choose Plus over Pro+ only when a Cursor editor seat would be waste, and
only when you still lack a door. That shopping-from-zero fork belongs on
[the cheapest door page](/blog/cheapest-way-into-grok-bot) and on
[the Plus stamp page](/blog/grok-bot-supergrok-plus). After a spike, the
fork is almost never live, because something already ran.

If you already hold both Plus and a Cursor eligible plan, Grok Bot uses
whichever has more usage. Do not assume the second subscription pours a
fresh weekly pool into the first. Heavy is eligible. Its allowance is as
unpublished as everyone else's.
...
Buying three more seats does not enlarge the Tuesday pool on your user.
It mints three more accounts, three more computers, three more weekly
meters. Routines still live on one Bot. You cannot reassign an inbox bot
by buying Premium. You copy the charter as text onto the new seat.
...
Cursor Ultra at $200 includes Grok Bot. That sentence is true and still
the wrong after-spike purchase for most invoices.

Ultra was a reasonable individual floor in the first week after launch on
11 August 2026, before eligibility widened on 21 August 2026. Roundups
that still start at two hundred are describing a list that no longer
exists. If you already wanted Ultra for the editor, overflow did not
...
[x.ai/pricing](https://x.ai/pricing) prints a number. If you already sit
on Ultra, stay. Pause the poller. You are over-clocked, not under-bought.

## Walk Yara from Tuesday 07:00 blank briefing to a billing tab she closes

Yara runs a one-person studio. She already holds Cursor Pro+ at $60 from
the 21 August widening. She does not need a door. She needs a pause.

Monday 24 August 2026, 08:15. A vendor thread feels hot. Twice a weekday
on [Inbox Triage](/bots/inbox-triage) feels slow. She sets every five
minutes. Labels only. Draft replies. Never send. The charter is otherwise
right. The clock is the mistake.
[Chief of Staff Briefing](/bots/chief-of-staff-briefing) stays on weekdays at
07:00. [Standup Scribe](/bots/standup-scribe) stays on weekdays at 09:00, DM
only. [Mail Cleanup Assistant](/bots/mail-cleanup-assistant) still has a
Sunday leftover from a July mailbox tidy.

Monday 08:15 through Tuesday 07:00 is about 23 hours. At 12 fires an hour
that is about 276 inbox runs if nights stay on. Treat 276 as arithmetic
from the clock, an arbitrary worked count, not a measured pool and not a
price. Briefing ran once Monday. Standup ran once Monday. Two useful runs,
then hundreds of polls against the same unpublished weekly pool.
...
| Clock | What Yara sees | Story in her head | What is true |
|---|---|---|---|
| Mon 24 Aug 08:15 | Inbox set to five minutes | Live mail needs a live clock | 12 fires an hour now share the weekly pool |
| Tue 25 Aug 07:00 | Briefing blank, quota language | Pro+ is too small | The account pool is empty. The poller may still be scheduled |
...
at $60. The failure was the clock, dated Tuesday 25 August 2026, set
Monday at 08:15. A higher plan would have inherited the same five-minute
owner.

## Paste a stay-or-upgrade sheet that cannot invent a Heavy price

Write the decision before the cart can write it for you. Paste this into
a file you own, not into a bot that can initiate spend.

\`\`\`text
AFTER-SPIKE STAY-OR-SKU (you fill this, the bot does not)
Date and time I paused every routine:
...
Forbidden on this sheet: any dollar figure for the weekly allowance,
  any SuperGrok Heavy price, any claim that a plan change refills
  this week, any spend cap I pretended the SKU would add.

BOT CLAUSE (paste into every remaining charter)
If usage is exhausted, quota is exceeded, or the product asks to
retry later, stop. Report that the weekly pool is empty. Wait.
Never initiate a paid upgrade, a credit top-up, or on-demand work
to keep going. Never send, pay, or publish while the pool is empty.
Never set inbox work tighter than twice a weekday.
Never treat overflow as permission to keep running.
\`\`\`

Prove the decision with a check that can fail. Four facts: the pause
...
A passed check is not a resume. Stay paused until you have a written
weekday clock and a desk. Rebuild inbox as a new named owner, twice a
weekday, after the old five-minute card is gone. Deleting that card
removes its routines. It does not sign out Gmail.
[Delete a bot safely](/blog/delete-a-grok-bot-safely) is a later hour.

## Answer the finance lead who treats overflow as a mandate to upgrade

The strongest case for buying a higher plan after overflow is simple.
The product ran out of included usage. Included usage is what you pay
the SKU for. If $60 emptied on Tuesday, $200 is the grown-up invoice.
Staying is leaving the company blocked. Overflow is the meter telling
you the door is too small. Pause is stalling. Finance would rather have
a line item than a missing briefing.

Grant the meter. Eligible plans include a weekly pool, then on-demand.
...
for the editor. Do not file the memo as Bot required two hundred because
of overflow. Finance can have a true line item: pause issued, poller
deleted, SKU unchanged, no invented allowance dollar.

## Stop using this page once the poller is gone and the door is already open

This page stops applying the moment the after-spike cart is the wrong
object.

If a five-minute clock is still live, you are in
[the this-hour stop](/blog/how-to-stop-grok-bot-overspending). Come back
after pause. If you never had an eligible invoice, you are in
[the cheapest door](/blog/cheapest-way-into-grok-bot). If you want the
weekly ritual that should have caught the poller before Tuesday, that is
[the Friday review](/blog/grok-bot-no-spend-cap-ops). If you are moving
from Pro at twenty to Pro+ at sixty with no spike, that is
[the Pro+ stamp](/blog/grok-bot-cursor-pro-plus). If you need the
two-phase meter without a purchase order, that is
[weekly allowance](/blog/grok-bot-weekly-allowance). Worth waits until
the poller is gone:
...
routine in the same week the pool emptied.
[Inbox Triage](/bots/inbox-triage) still never sends.
[Standup Scribe](/bots/standup-scribe) still never posts to a shared
