...
export default function FactsPage() {
  return (
    <main className="wrap detail">
      ...
      <p className="sub">
        Fifteen claims about Grok Bot that circulate in roundups, threads and vendor comparisons,
        each one wrong, and each with the documentation line that corrects it. We built this because
        we needed it ourselves: every article on this site is checked against it before it
        publishes.
      </p>

      <div className="callout">
        <b>Why this exists.</b> Most Grok Bot writing was published in the first fortnight after
        launch and has not been touched since. Prices moved on 21 August. A share path shipped that
        did not exist before. Two of the most repeated security claims were never true. If you are
        making a buying or security decision from a post you found in search, several of the numbers
        in it are probably stale.
      </div>
      ...
      <h2>Get it</h2>
      <p>
        One email, and it appears immediately on this page. We do not run a follow-up sequence, and
        we do not pass your address to anyone. You can also just read{' '}
