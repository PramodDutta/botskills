  ...
  return (
    <main className="wrap">
      <div className="hero">
        ...
        <h1>Rakazo skills</h1>
        <p className="sub">
          {rows.length} skills for Rakazo, the Apache-2.0 runtime where you choose the model and the
          sandbox. Same skill format, self-hosted control.
        </p>
      </div>
      ...
      <section>
        <div className="shead">
          <h2>Running Rakazo</h2>
        </div>
        <p className="sub">
          Rakazo is open source at{' '}
          <a href="https://github.com/elie222/rakazo" className="nm">
            github.com/elie222/rakazo
          </a>
